...
export async function deleteSpaceUsingPost(
  ...
  return request<API.BaseResponseMapStringObject_>('/api/space/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editSpaceUsingPost(
  ...
  return request<API.BaseResponseMapStringObject_>('/api/space/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateSpaceUsingPost(
  ...
  return request<API.BaseResponseMapStringObject_>('/api/space/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
