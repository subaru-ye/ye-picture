...
export async function deletePictureUsingPost(
  ...
  return request<API.BaseResponseMapStringObject_>('/api/picture/delete', {
    method: 'POST',
    headers: {
...
/** syncTagsAndCategoriesFromPublicPictures POST /api/picture/sync/tags_categories */
export async function syncTagsAndCategoriesFromPublicPicturesUsingPost(options?: {
  [key: string]: any
}) {
  return request<API.BaseResponseMapStringObject_>('/api/picture/sync/tags_categories', {
    method: 'POST',
    ...(options || {}),
  })
}
